...
class Config_EEG_finetune(Config_MBM_finetune):
    def __init__(self):
        ...
        self.eeg_signals_path = os.path.join(self.root_path, 'datasets/yinda.pth')
        self.splits_path = os.path.join(self.root_path, 'datasets/yindadataset_split.pth')
        self.dataset = 'EEG' 
...
class Config_Generative_Model:
    def __init__(self):
        ...
        self.seed = 2022
        self.root_path = './'
        self.output_path = r'E:\yinda\naodianproject\DreamDiffusion-main\18diffusion1.3\wandb'

        # self.eeg_signals_path = os.path.join(self.root_path, 'datasets/eeg_5_95_std.pth')
        self.eeg_signals_path = r'G:\yinda\dreamdiffusion\18\2.3pth\yinda.pth'
        self.splits_path = r'G:\yinda\dreamdiffusion\18\3.3split\all_dataset_split.pth'
        ...
        # finetune parameters
        self.batch_size = 10 if self.dataset == 'GOD' else 50
        self.lr = 5.3e-5
        self.num_epoch = 500
